package com.dhruw.bookhub.fragment
...
import com.dhruw.bookhub.adapter.DashboardRecyclerAdapter
...
class DashboardFragment : Fragment() {
    ...
    private lateinit var recycleDashboard : RecyclerView
...
*/
    ...
    val bookInfoList = arrayListOf<Book>(
          ...
          /* Book("P.S I Love You", "Cecelia Ahern", "Rs. 299", "4.5",R.drawable.ps_ily),
           ...
           Book("Lolita", "Vladimir Nabokov", "Rs. 399", "4.1", R.drawable.lolita),
           Book("Middlemarch", "George Elliot", "Rs. 444", "4.2",R.drawable.middlemarch),
           Book("The Adventure of Huckleberry finn", "Mark Twain", "Rs. 699", "4.5", R.drawable.adventures_finn),

           Book("Moby-Dick", "Harman Melville", "Rs. 499", "4.5",R.drawable.moby_dick),
